...
public class UtilityClassTest {
  ...
  public void concatWords_inputStringsHelloWorld_OutputsOneString() {
    ...
    @Test
    public void computeFactorial_Factorial6_Is720(){
    System.out.println("ComputeFactorial 6");
    assertEquals("720",UtilityClass.computeFactorial(6));
    }
    
    @Test
    public void computeFactorial_Factorial4_Is24(){
    System.out.println("ComputeFactorial 4");
    assertEquals("24",UtilityClass.computeFactorial(4));
    }
    @Test
    public void computeFactorial_Factorial10_Is3628800(){
...
//    final int factorialOf = 1 + (int) (90000 * Math.random());
